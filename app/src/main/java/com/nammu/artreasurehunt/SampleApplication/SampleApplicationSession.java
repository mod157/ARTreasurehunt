...
package com.nammu.artreasurehunt.SampleApplication;
...
public class SampleApplicationSession implements UpdateCallbackInterface
{
    ...
    private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            synchronized (mShutdownLock)
            {
                Vuforia.setInitParameters(mActivity, mVuforiaFlags, "");
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            if (result)
            {
                SLog.d( "InitVuforiaTask.onPostExecute: Vuforia "
            ...
            } else
            {
                ...
                // Log error:
                SLog.d("InitVuforiaTask.onPostExecute: " + logMessage
                    + " Exiting.");
    ...
    private class LoadTrackerTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            SLog.d("LoadTrackerTask.onPostExecute: execution "
